...
def test_calculate_custom_eval_metrics_overall(tmpdir):
    ...
    Returns:
        None
    """
    from components.evaluation import calculate_eval_metrics
    from components.evaluation.tfma_custom_metrics import example_count
    ...
    local_path = f"""
./components/evaluation/tfma_custom_metrics/{MODULE_TO_TEST}.py
""".replace(
        "\n", ""
    )
